...
const { createIncidencias, deleteIncidencias, getIncidencias, editarIncidencias, getHistorial } = require("../controllers/Incidencias.js");
const { getEstado, getUsuarioInci, getPrioridad } = require("../controllers/Select.js");
const { createConfiguracion, deleteConfiguracion, getConfiguraciones, editarConfiguracion } = require("../controllers/Configuracion.js")
